...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2022 at 11:31 AM
...
(1, 4, 1, 'The Witcher: Blood of elves', 499, 'Blood of Elves is the first novel in the Witcher Saga written by the Polish fantasy writer Andrzej Sapkowski, first published in Poland in 1994. It is a sequel to the Witcher short stories collected in the books The Last Wish and Sword of Destiny and is followed by Time of Contempt', 'thewitcher.png', 'witcher'),
(2, 6, 7, 'Darth Vader Vol. 1', 999, 'Darth Vader comics are based on his life after the destruction of the first death star', 'darth.jpg', 'darth vader'),
(3, 2, 3, 'Operation X', 599, 'This book is based on India\'s operation in the Pak vs Bangladesh war', 'ox.jpg', 'operation x');
...
(2, 'Divyansh ', 'Garg', 'divi010101@gmail.com', 'Password456', '9414588010', 'Bhilwara', 'Rajasthan');
